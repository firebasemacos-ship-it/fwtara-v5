...
const statusConfig: { [key in OrderStatus]: { text: string; icon: React.ReactNode; className: string } } = {
    ...
    ready: { text: 'تم التجهيز', icon: <PackageIcon className="w-5 h-5" />, className: 'bg-secondary/20 text-secondary-foreground border-secondary/30' },
    ...
    arrived_benghazi: { text: 'مع المندوب', icon: <Building className="w-5 h-5" />, className: 'bg-primary/10 text-primary border-primary/20' },
    arrived_tobruk: { text: 'وصلت إلى طرابلس', icon: <Building className="w-5 h-5" />, className: 'bg-primary/20 text-primary border-primary/30' },
