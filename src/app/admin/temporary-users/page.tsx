...
const statusConfig: { [key in OrderStatus]: { text: string; icon: React.ReactNode; className: string } } = {
    ...
    arrived_benghazi: { text: 'وصلت إلى بنغازي', icon: <Package className="w-4 h-4" />, className: 'bg-primary/10 text-primary' },
    arrived_tobruk: { text: 'وصلت إلى طبرق', icon: <Package className="w-4 h-4" />, className: 'bg-primary/20 text-primary' },
